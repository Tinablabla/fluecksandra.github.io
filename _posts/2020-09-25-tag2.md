...
Koha ist ein Open Source Bibliothekssystem, das weltweit eingesetzt wird (Quelle: [https://koha-community.org/](https://koha-community.org/)). Der OPAC sowie das "Staff Interface" können über eine Demoversion angeschaut werden: https://koha-community.org/. 
