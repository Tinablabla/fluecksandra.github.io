...
So sieht die Shell auf meinem Windows-Rechner aus. Ich habe den praktischer Befehl 

```pwd``` eingegeben. Mit diesem Befehl wird das aktuelle Directory angezeigt:
