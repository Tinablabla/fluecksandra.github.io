...
Offenbar ist es auch möglich, mit spitzen Klammern Ergebnisse direkt in eine Datei zu schreiben. Das wusste ich nicht (siehe dazu den Eintrag im Vorlesungsskript [Redirects und Pipes](https://bain.felixlohmeier.de/#/01_technische-grundlagen?id=redirects-und-pipes). In diesem Skript werden die Inhalte der Vorlesung mit ein paar Tagen Zeitverzug dauerhaft dokumentiert.). 
